...
public class ResourceServerConfiguration {
    ...
    @Value(value = "${auth.service.url:http://localhost:8080}")
    private String authServiceUrl;

    @Value(value = "${auth.service.client-id:login-service}")
    private String clientId;

    @Value(value = "${auth.service.client-secret:secret}")
        ...
        http
            ...
            .oauth2ResourceServer(oauth2 -> oauth2
                ...
                .opaqueToken(token -> token
                    .introspectionUri(authServiceUrl + "/auth/introspect")
